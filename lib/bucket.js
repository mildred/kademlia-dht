...
//
// Store timestamp of last node lookup
// Set up a timeout that trigger the refresh in tRefresh time
// Reset the timeout and set it again when a node lookup is performed outside of
// refresh
...
//
Bucket.prototype.markRefreshed = function () {
