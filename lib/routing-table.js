...
RoutingTable.prototype._eachBucket = function (cb, node, i) {
    ...
    if(node instanceof Bucket) {
        ...
        i = this.eachBucket(cb, node.left, i);
        i = this.eachBucket(cb, node.right, i);
        return i;
    }
};
...
RoutingTable.prototype.remove = function (contact) {
    ...
    this._addRemoveEndpoint(contact.endpoint);
    this._removeId(contact.id);
};
